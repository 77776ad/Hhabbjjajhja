...
client.on("message", message => {
  ...
  if (msg.startsWith(prefix + "WEATHER")) {
    ...
    //.find({ search: args.join(" "), degreeType: "F" }, function(
...
client.on("guildMemberAdd", member => {
  ...
  member.guild.fetchInvites().then(guildInvites => {
    ...
    setTimeout(() => {
     ...
     // logChannel.send("**__W__elcome ~~T~~o** " + `**${member.guild.name}**` +   "<a:586820123281588226:602887804879503381>")

   //   logChannel.send("<a:4577:594276367525216276> **  User : **" + `${member}` + "..");
